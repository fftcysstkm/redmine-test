...
INSERT INTO `ar_internal_metadata` VALUES ('environment','production','2022-11-12 09:11:52','2022-11-12 09:11:52');
...
INSERT INTO `attachments` VALUES (1,2,'Issue','hoge.txt','221112092307_hoge.txt',11,'text/plain','bebbd5b1bb8bb7aab49e394c56e6c497b6085bd8baff6e9e20fabbb04e733e5e',0,1,'2022-11-12 09:23:07','','2022/11');
...
CREATE TABLE `easy_entity_assignments` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `entity_from_type` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `entity_from_id` int(11) DEFAULT NULL,
  `entity_to_type` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `easy_settings` VALUES (1,NULL,'easy_gantt_show_holidays','--- false\n',NULL),(2,NULL,'easy_gantt_relation_delay_in_workdays','--- false\n',NULL),(3,NULL,'easy_gantt_show_project_progress','--- true\n',NULL),(4,NULL,'easy_gantt_show_task_soonest_start','--- false\n',NULL),(5,NULL,'easy_gantt_default_zoom','--- day\n',NULL);
...
INSERT INTO `email_addresses` VALUES (1,1,'admin@example.net',1,1,'2022-11-12 09:11:51','2022-11-12 09:11:51'),(2,5,'t_satou@boisb.com',1,1,'2022-11-12 09:14:28','2022-11-12 09:14:28');
...
INSERT INTO `enabled_modules` VALUES (1,1,'issue_tracking'),(2,1,'time_tracking'),(3,1,'news'),(4,1,'documents'),(5,1,'files'),(6,1,'wiki'),(7,1,'repository'),(8,1,'boards'),(9,1,'calendar'),(10,1,'gantt'),(11,1,'kanban'),(12,1,'easy_gantt');
...
INSERT INTO `enumerations` VALUES (1,'高い',1,0,'IssuePriority',1,NULL,NULL,'lowest'),(2,'通常',2,1,'IssuePriority',1,NULL,NULL,'default'),(3,'低い',3,0,'IssuePriority',1,NULL,NULL,'highest');
...
INSERT INTO `issue_statuses` VALUES (1,'新規',0,1,NULL),(2,'着手',0,2,NULL),(3,'終了',0,3,NULL);
...
INSERT INTO `issues` VALUES (1,1,1,'AI画像生成機能の実装','','2022-11-18',NULL,1,1,2,NULL,1,5,'2022-11-12 09:21:04','2022-11-12 12:08:16','2022-11-14',0,NULL,NULL,1,1,6,0,NULL),(2,1,1,'基本設計書作成','','2022-11-15',NULL,1,1,2,NULL,1,1,'2022-11-12 09:23:12','2022-11-12 12:08:16','2022-11-14',0,0,1,1,2,3,0,NULL),(3,1,1,'詳細設計書の作成','','2022-11-18',NULL,1,1,2,NULL,1,2,'2022-11-12 11:47:27','2022-11-12 11:48:35','2022-11-15',0,NULL,1,1,4,5,0,NULL);
...
INSERT INTO `journal_details` VALUES (1,1,'attr','due_date',NULL,'2022-11-18'),(2,2,'attr','subject','基本設計','詳細設計書の作成'),(3,3,'attr','tracker_id','3','1'),(4,4,'attr','start_date','2022-11-12','2022-11-14'),(5,4,'attr','estimated_hours',NULL,'0.0');
...
INSERT INTO `journals` VALUES (1,1,'Issue',1,'','2022-11-12 09:21:19',0),(2,3,'Issue',1,'','2022-11-12 11:47:52',0),(3,3,'Issue',1,'','2022-11-12 11:48:35',0),(4,2,'Issue',1,'','2022-11-12 12:08:16',0);
...
INSERT INTO `projects` VALUES (1,'テストプロジェクト','','',1,NULL,'2022-11-12 09:13:43','2022-11-12 09:13:43','test-project',1,1,2,0,NULL,NULL);
...
INSERT INTO `settings` VALUES (1,'rest_api_enabled','1','2022-11-12 09:17:21'),(2,'jsonp_enabled','0','2022-11-12 09:17:21');
...
INSERT INTO `tokens` VALUES (2,1,'session','37277ddaaa1225aae60d29078a948ed008e2b6b4','2022-11-12 09:13:06','2022-11-12 12:09:39'),(3,1,'feeds','6b6fc3aa39a4d7e6425a20dbec81895c036fe26a','2022-11-12 09:13:21','2022-11-12 09:13:21'),(4,1,'api','562ede4e465152b0131fd86806df6ef093d1710b','2022-11-12 09:17:26','2022-11-12 09:17:26');
...
INSERT INTO `trackers` VALUES (1,'案件','',0,1,1,0,1),(2,'バグ','',0,2,1,0,1),(3,'タスク','',0,3,1,0,1);
...
CREATE TABLE `users` (
  ...
  `twofa_scheme` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `twofa_totp_key` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `users` VALUES (1,'admin','54f4cb67bf9150cc87bedb5d127d0759446a50c8','太郎','テスト',1,1,'2022-11-12 09:12:46','ja',NULL,'2022-11-12 09:11:45','2022-11-12 09:13:18','User',NULL,'all','f5eb0ecdb4c931dd2583489cd8cfdba5',0,'2022-11-12 09:13:06',NULL,NULL,NULL),(2,'','','','Anonymous users',0,1,NULL,'',NULL,'2022-11-12 09:11:50','2022-11-12 09:11:50','GroupAnonymous',NULL,'',NULL,0,NULL,NULL,NULL,NULL),(3,'','','','Non member users',0,1,NULL,'',NULL,'2022-11-12 09:11:50','2022-11-12 09:11:50','GroupNonMember',NULL,'',NULL,0,NULL,NULL,NULL,NULL),(4,'','','','Anonymous',0,0,NULL,'',NULL,'2022-11-12 09:12:33','2022-11-12 09:12:33','AnonymousUser',NULL,'only_my_events',NULL,0,NULL,NULL,NULL,NULL),(5,'t_satou','07a7f9f59158e24a0015d4cfcb8a31cf2105e2c9','琢馬','佐藤',1,1,NULL,'ja',NULL,'2022-11-12 09:14:28','2022-11-12 09:14:28','User',NULL,'only_my_events','fb57dc70f12af76303142e915d2038d9',0,'2022-11-12 09:14:28',NULL,NULL,NULL);
...
-- Dump completed on 2022-11-12 12:20:03
